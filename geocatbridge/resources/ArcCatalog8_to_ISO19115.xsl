...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template match="/">
		<Metadata>
			<xsl:apply-templates select="metadata/Esri/MetaID"/>
			<xsl:apply-templates select="metadata/mdFileID"/>
			<xsl:apply-templates select="metadata/uuid"/>
...
<!--			<xsl:for-each select="distTranOps">
	...
	<xsl:template match="dataIdInfo">
		<dataIdInfo>
			...
			</xsl:for-each><graphOver><bgFileName>small.bmp</bgFileName><bgFileDesc>thumbnail</bgFileDesc><bgFileType>small</bgFileType></graphOver>
