...
![About panel](img/first_time.png)
...
If you would like to contribute to the translations, please join the {{ short_name }} [Transifex project](https://explore.transifex.com/geocat/bridge-common).
